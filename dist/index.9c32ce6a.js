...
})({"2SM0S":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "3b05c963d8f23f1b787097969c32ce6a";
// @flow
...
},{}],"4E06r":[function(require,module,exports) {
"use strict";
...
*/
const randomArrNum = Array.from(Array(5), (_, i) => Math.floor(Math.random() * 51 + 1));
// console.log(randomArrNum);
const handDisplay = hand => {
  const values = "23456789TJQKA";
  const suits = [`♣︎`, `♦︎`, `♥︎`, `♠︎`];
  return hand.map(el => {
    return `${values[el % values.length]}${suits[Math.floor(el / values.length)]}`;
  }).join(" ");
};
exports.default = handDisplay(randomArrNum);
